...
export default function PatientDetail() {
    ...
    return (
        ...
        <main className="flex-1 p-6 sm:p-8 overflow-auto">
            ...
            <DashboardCard icon={<Activity className="text-emerald-400" size={32} />} title="Brazo Mecánico" />
            <DashboardCard icon={<Brain className="text-blue-400" size={32} />} title="Laberinto Canica" />
            <DashboardCard icon={<FileCheck className="text-pink-400" size={32} />} title="Code & Go" />
            <DashboardCard icon={<BarChart className="text-purple-400" size={32} />} title="Progreso" />
            </section>
    ...
    return (
        <div className="bg-gray-800 rounded-xl p-5 shadow-lg hover:shadow-teal-500/20 hover:-translate-y-1 transition-all text-center">
